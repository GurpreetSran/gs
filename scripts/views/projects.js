...
Projects = React.createClass({
  ...
  loadMoreProjects: function (e) {
    ...
    if (currentProjects.length) {
      currentPageRows++;
      addRow.push(currentProjects.splice(0, itemsInRow * 2));
    ...
    if (noProjectAvailable) {
      return (
        <div>
          ...
          <div className="container">
            <p className="error">Invalid project id or URL</p>
            <br />
      ...
      <div className="projects">
        <div className="jumbotron">
          <div className="container">
            <h1>
              {" "}
              {this.getActualTitle(header)
                ? this.getActualTitle(header) + " Projects"
                : "Projects"}{" "}
            </h1>
          </div>
        </div>
        ...
        <div className="container text-center">
          <a
            id="loadMore"
            className={this.state.loadMoreBtn ? "linkStyle1" : "hide"}
